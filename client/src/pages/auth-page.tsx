...
const registerSchema = insertUserSchema.omit({ profileImageUrl: true }).extend({
      ...
      <div className="md:w-1/2 gradient-bg-primary p-8 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="max-w-lg text-center text-white relative z-10 animate-in">
          ...
          <p className="text-xl mb-6">
            Connect with neighbors, share dump fees, and save money while keeping your space clutter-free.
          </p>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-3">
                      ...
                      <Button variant="outline" className="w-full">
                        <BsTwitter className="h-5 w-5 text-blue-400" />
                      </Button>
                    </div>
                  </div>
                </CardContent>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center space-x-2">
                            ...
                            <FormLabel className="cursor-pointer">
                              I have a truck/vehicle to transport items
                            </FormLabel>
                          </FormItem>
                        )}
                      />
...
function Truck(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L16 6h-6v11h4" />
